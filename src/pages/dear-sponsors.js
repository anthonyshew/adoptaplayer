...
const SuccessMessage = () => (
    <p className="success">Thank you for signing up! Currently, we have many sponsors waiting for a player to be matched with them and we will be adding your name to the list. We will inform you when your name is next!</p>
)
